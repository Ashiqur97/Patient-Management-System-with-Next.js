...
const RegisterForm =({user}:{user:User}) => {
  ...
  async function onSubmit({name,email,phone}: z.infer<typeof PatientFormValidation>) {
    ...
    try {
      ...
      if(patient) router.push(`/patients/${user.$id}/${user.$id}/new-appointment`)
    } catch (error) {
      console.log(error);
    }
  }
    ...
    className="space-y-12 flex-1">
      ...
      />
        ...
        <CustomFormField
            ...
            name="occupation"
            label="Occupation"
            placeholder="Software Engineer" iconSrc={""}        />
          </div>
          ...
          <CustomFormField
            ...
            placeholder="Guardian's name" iconSrc={""}            />
      ...
      <CustomFormField
          ...
          placeholder="Select a physician" iconSrc={""}>
      ...
      <CustomFormField
          ...
          placeholder="Select an identification type" iconSrc={""}>
